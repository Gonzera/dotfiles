...
let g:floaterm_keymap_new    = get(g:, 'floaterm_keymap_new', '<F9>')
let g:floaterm_keymap_prev   = get(g:, 'floaterm_keymap_prev', '<F10>')
let g:floaterm_keymap_next   = get(g:, 'floaterm_keymap_next', '<F11>')
...
let g:floaterm_keymap_toggle = get(g:, 'floaterm_keymap_toggle', '<F12>')
